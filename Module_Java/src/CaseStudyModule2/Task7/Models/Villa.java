...
public class Villa extends Services {
    ...
    public Villa(String ID, String nameServices, double areaUsed, double rentalCost, double maxinumNumber,
                 double typeRent, String roomStandard, String otherFacilities, double poolArea, int numberOfFloor) {
    ...
    public void showInfor() {
        System.out.println("Name Services : " + super.getNameServices() +
